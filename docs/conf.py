...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'msgqueue'))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, '..'))
sys.path.insert(0, src_path)

import msgqueue  # noqa
...
project = u'msgqueue'
_full_version = msgqueue.__version__
author = msgqueue.__author__
copyright = msgqueue.__copyright__
...
latex_documents = [
    (master_doc, 'msgqueue.tex', u'msgqueue Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'msgqueue', 'msgqueue Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'msgqueue', 'msgqueue Documentation',
     author, 'msgqueue', msgqueue.__descr__,
     'Miscellaneous'),
]
